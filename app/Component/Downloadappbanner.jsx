...
function Downloadappbanner() {
  ...
  >
      <div className="flex flex-col py-11 pl-11 ">        
        <h2 className="text-3xl font-black pb-6">Buy, Sell & Rent Properties – Download HexaHome App Now!</h2>

        <div className="flex flex-col gap-3">
          {dataa.map((data, index) => (
            <div key={index} className="flex flex-row text-2xl font-normal leading-6 items-center gap-3">
              <Image src={data.image} alt={data.id} width={20} height={16} />
              <p className="flex ">{data.para}</p>
            </div>
          ))}
          <div className="flex flex-row gap-6 pt-5">
            ...
            <div className="flex flex-col">
              <p className="text-2xl font-semibold leading-7 pb-3">Scan to Download our App</p>
              <p className="pb-3 text-xl font-normal">Available on iOS & Android – Download Now!</p>
